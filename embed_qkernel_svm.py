...
init_params = random_params(num_wires=4, num_layers=5)
...
accuracy_trained = accuracy(svm2, X_full, Y_full)
print(f"The accuracy of a kernel with trained svm on FULL data is {accuracy_trained:.3f}")
